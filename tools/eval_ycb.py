...
for now in range(0, 2949):
    ...
    for idx in range(len(lst)):
        ...
        try:
            ...
            # print("mask_label{}".format(mask_label))
            ...
            # print("pred_c:{}".format(pred_c))
            how_max, which_max = torch.max(pred_c, 1)
            # print("which_max:{}".format(which_max[0]))
            ...
            for ite in range(0, iteration):
                ...
                index_ = index.item() # get object number
            ...
            print("quaternion:{0}, translation:{1}, index: {2}".format(my_pred[:4],my_pred[4:], index_))
            # print(my_pred)
